    ...
    return (
        <div className="flex gap-4 items-center p-4 ">
            <div className="flex w-[290px] h-[59px] items-center gap-5 px-7 py-0 relative bg-[rgb(89,87,166)] rounded-[30px] overflow-hidden border border-solid border-[#020202]">
                <span className="flex-grow text-center font-bold text-xl">Gyuwons PinBox</span>
                <div>
                    <img
                        className="w-12 h-12 rounded-full border border-solid border-[#020202] bg-[rgb(255,255,255)]"
                        src={gyuwon}
                        alt="Gyuwon"
                    />
                </div>
