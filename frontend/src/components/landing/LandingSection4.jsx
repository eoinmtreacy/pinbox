    ...
    return (
        ...
        >
            <div className="flex justify-center items-center px-16 py-20 bg-white max-md:px-5">
                <div className="flex justify-center flex-col items-center w-full max-w-[1680px] max-md:max-w-full">
                    <div className="text-7xl font-black tracking-tighter text-zinc-900 max-md:max-w-full max-md:text-4xl">
                        Busyness Heat Map
                    </div>
                    <div className="mt-6 text-2xl tracking-tighter text-black max-w-[800px] w-[820px] max-md:max-w-full text-center">
                        Discover the busyness levels of various areas in Manhattan with our interactive heat map.
                    </div>
                    <div className="flex justify-center items-center mt-7">
                        <img className="object-cover w-[1200px] h-[450px] rounded-2xl" src={Heatmap} alt="Map" />
                    </div>
