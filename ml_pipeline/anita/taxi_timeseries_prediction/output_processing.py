...
# Read the data
df = pd.read_csv("ml_pipeline/prediction_july.csv")
print(df.head())
...
df.to_csv('ml_pipeline/july_prediction_data.csv')

# Load the original dataset
original_df = pd.read_csv("ml_pipeline/updated_passenger_count.csv")


# Load the prediction dataset
prediction_df = pd.read_csv("ml_pipeline/june_prediction_data.csv")
...
print("Updated dataset saved to ml_pipeline/updated_passenger_count.csv")
